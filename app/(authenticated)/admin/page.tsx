...
const Page = () => {
  ...
  const handleEdit = (id: string) => {
    setPropertyId(id);
    setActiveTab(0); // Assuming the form is on the first tab
  };
  const tabs = [
    {
    ...
    },
    {
      ...
      content: <PreConstructedPropertyForm />,
    },
    {
      ...
      content: <FeaturedListing onEdit={handleEdit} />,
    },
    {
